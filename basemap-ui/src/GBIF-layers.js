...
GBIF_Layers['3857_Base_Vector'] = new ol.layer.VectorTile({
...
GBIF_Layers['3857_Base_Raster'] = new ol.layer.Tile({
	source: new ol.source.TileImage({
		...
		tilePixelRatio: 2,
		url: gbifBaselayerBase + '/3857/omt/{z}/{x}/{y}@2x.png?style=gbif-classic',
		wrapX: true
	}),
});

GBIF_Layers['3857_OccurrenceDensity_Vector'] = new ol.layer.VectorTile({
	renderMode: 'image',
        source: new ol.source.VectorTile({
		format: new ol.format.MVT(),
		projection: 'EPSG:3857',
		...
		tilePixelRatio: 8,
		url: gbifOccurrenceVectorLayerBase + '/map/occurrence/density/{z}/{x}/{y}.mvt?srs=EPSG:3857&bin=hex&hexPerTile=61',
		wrapX: false
        }),
        style: densityStyle()
});

GBIF_Layers['3857_OccurrenceDensity_Raster'] = new ol.layer.Tile({
        source: new ol.source.TileImage({
		projection: 'EPSG:3857',
 		tileGrid: ol.tilegrid.createXYZ({
			maxZoom: 16,
		...
		tilePixelRatio: 2,
		url: gbifOccurrenceRasterLayerBase + '/map/occurrence/density/{z}/{x}/{y}@2x.png?srs=EPSG:3857&bin=hex&hexPerTile=61&style=classic.poly',
		wrapX: true
        }),
});
...
GBIF_Layers['4326_Base_Vector'] = new ol.layer.VectorTile({
	extent: GBIF_4326.extent(),
        source: new ol.source.VectorTile({
		projection: GBIF_4326.projection(),
	  	tileGrid: GBIF_4326.tileGrid(),
...
GBIF_Layers['4326_Base_Raster'] = new ol.layer.Tile({
	//extent: GBIF_4326.extent(),
	source: new ol.source.TileImage({
		projection: GBIF_4326.projection(),
	  	tileGrid: GBIF_4326.tileGrid(),
		tilePixelRatio: 2,
		url: gbifBaselayerBase + '/4326/omt/{z}/{x}/{y}@2x.png?style=gbif-classic',
		wrapX: true
	}),
});

GBIF_Layers['4326_OccurrenceDensity_Vector'] = new ol.layer.VectorTile({
	extent: GBIF_4326.extent(),
	renderMode: 'image',
        source: new ol.source.VectorTile({
		projection: GBIF_4326.projection(),
		...
		tilePixelRatio: 8,
		format: new ol.format.MVT(),
		url: gbifOccurrenceVectorLayerBase + '/map/occurrence/density/{z}/{x}/{y}.mvt?srs=EPSG:4326&bin=hex&hexPerTile=61',
        }),
        style: densityStyle()
});

GBIF_Layers['4326_OccurrenceDensityAdhoc_Vector'] = new ol.layer.VectorTile({
	//extent: GBIF_4326.extent(),
	renderMode: 'image',
        source: new ol.source.VectorTile({
		projection: GBIF_4326.projection(),
		...
		tilePixelRatio: 8,
		format: new ol.format.MVT(),
		url: gbifOccurrenceVectorLayerBase + '/map/occurrence/adhoc/{z}/{x}/{y}.mvt?srs=EPSG:4326&bin=hex&hexPerTile=61',
		wrapX: true,
        }),
        style: densityStyle()
});

GBIF_Layers['4326_OccurrenceDensity_Raster'] = new ol.layer.Tile({
	//extent: GBIF_4326.extent(),
        source: new ol.source.TileImage({
		projection: GBIF_4326.projection(),
	  	tileGrid: GBIF_4326.tileGrid(),
		tilePixelRatio: 2,
		url: gbifOccurrenceRasterLayerBase + '/map/occurrence/density/{z}/{x}/{y}@2x.png?srs=EPSG:4326&bin=hex&hexPerTile=61&style=classic.poly',
		wrapX: true
        }),
	visible: true
});
...
GBIF_Layers['3575_Base_Vector'] = new ol.layer.VectorTile({
        extent: GBIF_3575.extent(),
        source: new ol.source.VectorTile({
                projection: GBIF_3575.projection(),
                format: new ol.format.MVT(),
...
GBIF_Layers['3575_Base_Raster'] = new ol.layer.Tile({
        extent: GBIF_3575.extent(),
	source: new ol.source.TileImage({
                projection: GBIF_3575.projection(),
                tileGrid: GBIF_3575.tileGrid(),
		url: gbifBaselayerBase + '/3575/omt/{z}/{x}/{y}@2x.png?style=gbif-classic',
		tilePixelRatio: 2,
	}),
});

GBIF_Layers['3575_OccurrenceDensity_Vector'] = new ol.layer.VectorTile({
	extent: GBIF_3575.extent(),
	renderMode: 'image',
        source: new ol.source.VectorTile({
		projection: GBIF_3575.projection(),
		...
		tilePixelRatio: 8,
		format: new ol.format.MVT(),
		url: gbifOccurrenceVectorLayerBase + '/map/occurrence/density/{z}/{x}/{y}.mvt?srs=EPSG:3575&bin=hex&hexPerTile=61',
        }),
        style: densityStyle()
});

GBIF_Layers['3575_OccurrenceDensity_Raster'] = new ol.layer.Tile({
        extent: GBIF_3575.extent(),
        source: new ol.source.TileImage({
                projection: GBIF_3575.projection(),
                tileGrid: GBIF_3575.tileGrid(),
		tilePixelRatio: 2,
		url: gbifOccurrenceRasterLayerBase + '/map/occurrence/density/{z}/{x}/{y}@2x.png?srs=EPSG:3575&bin=hex&hexPerTile=61&style=classic.poly',
        }),
});
...
GBIF_Layers['3031_Base_Vector'] = new ol.layer.VectorTile({
        extent: GBIF_3031.extent(),
        source: new ol.source.VectorTile({
                projection: GBIF_3031.projection(),
                format: new ol.format.MVT(),
...
GBIF_Layers['3031_Base_Raster'] = new ol.layer.Tile({
        extent: GBIF_3031.extent(),
	source: new ol.source.TileImage({
		projection: 'EPSG:3031',
	  	tileGrid: GBIF_3031.tileGrid(),
		url: gbifBaselayerBase + '/3031/omt/{z}/{x}/{y}@2x.png?style=gbif-classic',
		tilePixelRatio: 2,
	}),
});

GBIF_Layers['3031_OccurrenceDensity_Vector'] = new ol.layer.VectorTile({
	extent: GBIF_3031.extent(),
	renderMode: 'image',
        source: new ol.source.VectorTile({
		projection: GBIF_3031.projection(),
		...
		tilePixelRatio: 8,
		format: new ol.format.MVT(),
		url: gbifOccurrenceVectorLayerBase + '/map/occurrence/density/{z}/{x}/{y}.mvt?srs=EPSG:3031&bin=hex&hexPerTile=61',
        }),
        style: densityStyle()
});

GBIF_Layers['3031_OccurrenceDensity_Raster'] = new ol.layer.Tile({
	extent: GBIF_3031.extent(),
        source: new ol.source.TileImage({
                projection: GBIF_3031.projection(),
		tileGrid: GBIF_3031.tileGrid(),
		tilePixelRatio: 2,
		url: gbifOccurrenceRasterLayerBase + '/map/occurrence/density/{z}/{x}/{y}@2x.png?srs=EPSG:3031&bin=hex&hexPerTile=61&style=classic.poly',
        }),
});

window.GBIF_Layers = GBIF_Layers;
