...
INSERT INTO split_land_polygons_3575 (fid, tolerance, min_area, zoom, x, y, geometry)
    SELECT p.fid, 0, 0, :zoom, b.x, b.y, ST_Multi(ST_Intersection(p.geometry, b.geometry))
...
INSERT INTO split_land_polygons_3575 (fid, tolerance, min_area, zoom, x, y, geometry)
    SELECT p.fid, p.tolerance, p.min_area, :zoom, b.x, b.y, ST_Multi(ST_Intersection(p.geometry, b.geometry))
